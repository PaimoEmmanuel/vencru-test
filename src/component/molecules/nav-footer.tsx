...
const NavFooter: React.FunctionComponent<INavFooterProps> = (props) => {
  return (
    <footer className="footer">
      <ul className="footer__links">
        ...
        <li className="footer__link active">
          <a href="#home" title="Home">
            <svg
              width="24"
              height="24"
      ...
      <div className="footer__feature">
        <p className="footer__feature--heading">New features available!</p>
        <p className="footer__feature--text">
          Check out the new dashboard view. Pages now load faster.{" "}
        </p>
        <div className="footer__feature--img">
          <svg
            width="48"
            height="48"
            viewBox="0 0 48 48"
      ...
      <div className="footer__account">
        <img
          className="footer__account--avatar"
          src="/assets/avatar.png"
          alt="Olivia Rhye"
        />
        <div>
          <p className="footer__account--name">Olivia Rhye</p>
          <p className="footer__account--mail">olivia@untitledui.com</p>
        </div>
        <button
